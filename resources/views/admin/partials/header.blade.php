                ...
                <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                   <a href="#"
                      ...
                      <div class="quick-icon border border-light"><img class="icon"
                         src="{{ admin_assets() }}/images/flags/english-sq.png" alt=""></div>
                   </a>
                   <div class="dropdown-menu dropdown-menu-end dropdown-menu-s1">
                      <ul class="language-list">
                         <li><a href="#" class="language-item"><img
                            src="{{ admin_assets() }}/images/flags/english.png" alt=""
                            class="language-flag"><span
                            class="language-name">English</span></a></li>
                         <li><a href="#" class="language-item"><img
                            src="{{ admin_assets() }}/images/flags/spanish.png" alt=""
                            class="language-flag"><span
                            class="language-name">Español</span></a></li>
                         <li><a href="#" class="language-item"><img
                            src="{{ admin_assets() }}/images/flags/french.png" alt=""
                            class="language-flag"><span
                            class="language-name">Français</span></a></li>
                         <li><a href="#" class="language-item"><img
                            src="{{ admin_assets() }}/images/flags/turkey.png" alt=""
                            class="language-flag"><span
                   ...
                   <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                      ...
                      <div class="dropdown-inner">
                         <ul class="link-list">
                            ...
                            <li><a href="settings.html"><em
                               class="icon ni ni-setting-alt"></em><span>Account
                               Setting</span></a>
                            </li>
                            <li><a href="settings-activity-log.html"><em
