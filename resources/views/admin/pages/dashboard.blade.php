                         ...
                         <div class="card-inner">
                            ...
                            <div class="invest-data">
                               ...
                               <div class="invest-data-ck">
                                  <canvas class="iv-data-chart"
                                     id="totalBooking"></canvas>
                               </div>
                            </div>
                         </div>
                      </div>
                         ...
                         <div class="card-inner">
                            ...
                            <div class="traffic-channel">
                               <div class="traffic-channel-doughnut-ck">
                                  <canvas
                                     class="analytics-doughnut" id="BookingData"></canvas>
                               </div>
                            ...
                            <div class="analytic-ov">
                               <div class="analytic-data-group analytic-ov-group g-3">
                                  ...
                                  <div class="analytic-data analytic-ov-data">
                                     ...
                                     <div class="change down"><em
                                        class="icon ni ni-arrow-long-up"></em>8.37%
                                     </div>
                                  </div>
                               </div>
                         ...
                         <div class="card-inner-group">
                            <div class="card-inner">
                               <div class="card-title-group">
                                  ...
                                  <div class="card-tools"><a href="customers.html"
                            ...
                            <div class="card-inner card-inner-md">
                               <div class="user-card">
                                  ...
                                  <div class="user-info"><span class="lead-text">Tasnim
                                     Ifrat</span><span
                                        class="sub-text">tasif-85@example.com</span>
                                  </div>
                                  <div class="user-action">
                                     <div class="drodown">
                                        <a href="#"
                         ...
                         <ul class="nk-activity">
                            <li class="nk-activity-item">
                               <div class="nk-activity-media user-avatar bg-success"><img
                                  src="{{ admin_assets() }}/images/avatar/c-sm.jpg" alt=""></div>
                            ...
                            <li class="nk-activity-item">
                               <div class="nk-activity-media user-avatar bg-purple"><img
                                  src="{{ admin_assets() }}/images/avatar/d-sm.jpg" alt=""></div>
                               <div class="nk-activity-data">
