...
<head>
  ...
  <!-- Stylesheets -->
  <link rel="stylesheet" href="{{ website_assets() }}/css/vendors.css">
  <link rel="stylesheet" href="{{ website_assets() }}/css/main.css">

  <title>TripRemidy</title>
</head>
...
<body>
  <div class="preloader js-preloader">
    ...
    <div class="preloader__title">TRIPREMIDY</div>
  </div>
  ...
  <script src="{{ website_assets() }}/js/index.min.js"></script>

  <script src="{{ website_assets() }}/js/vendors.js"></script>
